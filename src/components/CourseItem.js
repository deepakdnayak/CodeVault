        ...
        <>
            <div className="card mb-2">
                <div className="card-body">
                    ...
                    <Link to="/notes" state={{ semester: props.semester, type: "notes", courseCode: props.courseCode }} className="card-link"><button type="button" className="btn btn-secondary">Check Course</button></Link>
